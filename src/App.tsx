...
const App = () => {
  ...
  const [highScoreLevel, setHighScoreLevel] = useState<"easy" | "hard">("easy"); //set which level to show high score
  ...
  if (isGameOn)
    ...
    return (
      <div className="home_screen">
        <img src={mainLogo} alt="main logo" height={80} width={80}></img>
        ...
        >
          <h3> Your Stats</h3>
          Personal Best (Easy): {personalBest.easy} <br /> Personal Best (Hard):{" "}
          {personalBest.hard}
        </div>
      </div>
    );
